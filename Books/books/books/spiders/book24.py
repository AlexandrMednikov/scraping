...
from books.items import BookparserBook24Item
...
class Book24Spider(scrapy.Spider):
    ...
    def parse_item(self, response:HtmlResponse):
        ...
        yield BookparserBook24Item(title=title, link=link, author=author, own_price=own_price, sale_price=sale_price, rating=rating)
